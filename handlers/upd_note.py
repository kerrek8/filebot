...
@router.callback_query(F.data.startswith('dell_note_'))
...
@router.callback_query(F.data.startswith('edit_note_text_'))
...
@router.message(F.text, UPDNoteStates.content_text)
